  ...
  return (
    <>
      ...
      <div className="text-center my-4">
        <a href='https://front-registrar.vercel.app/' className="underline mx-2">
          Registrar
        </a>
        <a href='https://front-mostrar.vercel.app/' className="underline mx-2">
          Mostrar Lista
        </a>
      </div>
      <div className="text-center my-4">
        <a href='https://front-consultar.vercel.app/' className="underline mx-2">
          Consultar
        </a>
        <a href='https://front-editar.vercel.app/' className="underline mx-2">
          Editar
        </a>
      </div>
      <div className="text-center my-4">
        <a href='https://front-eliminar.vercel.app/' className="underline mx-2">
          Eliminar
        </a>
      </div>
      <div className="text-center my-4">
